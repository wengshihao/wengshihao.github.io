...
\PassOptionsToPackage{style=ieee,sorting=none,uniquename=full,defernumbers=true,giveninits=false,maxbibnames=99,minbibnames=99}{biblatex}
...
% A deliberately compact and uniform CV bibliography style:
% Authors. "Title." In: Full venue name (Acronym Year), CCF rank.
\DeclareFieldFormat{cvtitle}{\mkbibquote{#1}}
\newbibmacro*{cv:author-title}{%
  \printnames{author}%
  \setunit{\addperiod\space}%
  \printfield[cvtitle]{title}%
  \setunit{\addperiod\space}%
}
\DeclareBibliographyDriver{inproceedings}{%
  \usebibmacro{begentry}%
  \usebibmacro{cv:author-title}%
  \printtext{In:\space}%
...
\DeclareBibliographyDriver{misc}{%
  \usebibmacro{begentry}%
  \usebibmacro{cv:author-title}%
  \printtext{In: arXiv Preprint (}%
  \printtext{arXiv: \href{https://arxiv.org/abs/\thefield{eprint}}{\texttt{\thefield{eprint}}}}%
  \setunit{\addcomma\space}%
  \printfield{year}%
  \printtext{)}%
  \usebibmacro{finentry}%
...
\leftheader{%
  {\LARGE\bfseries\sffamily Shihao Weng}

  \makefield{\faEnvelope[regular]}{\href{mailto:shweng@smail.nju.edu.cn}{\texttt{shweng@smail.nju.edu.cn}}}
  ...
  %% Next line
  \makefield{\faGlobe}{\href{https://wengshihao.github.io/}{Homepage}}
  \makefield{\faGithub}{\href{https://github.com/wengshihao}{GitHub}}
  \makefield{\faGraduationCap}{\href{https://scholar.google.com/citations?user=TzFeU_IAAAAJ}{Google Scholar}}
